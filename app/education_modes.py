...
class AnimalSoundGame(Game):
    ...
    # 🔴 2026-08-26: 여기 지시문이 "첫 문장은 놀이를 하자는 **밝은 인사**"였다. LLM 은
    #    '인사'를 '안녕'으로 읽었고, 대화 4턴째에 "안녕! 강아지는 멍?" 이 나갔다.
    #    가드가 뚫린 게 아니라 **시킨 대로 한 것**이다 — 폴백 템플릿이 뜻하던 건
    #    첫인사가 아니라 '신나게 받는 말'이었다. 낱말 하나가 뜻을 뒤집었다.
